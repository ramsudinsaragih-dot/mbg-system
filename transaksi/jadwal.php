...
<head>
    ...
    <title>Jadwal Distribusi - MBG System</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="distribusi.php"><i class="fas fa-box"></i> Distribusi</a></li>
            
            <li class="menu-title">Lainnya</li>
            <li><a href="jadwal.php" class="active"><i class="fas fa-calendar"></i> Jadwal</a></li>
    ...
    <div class="content">
        <div class="navbar-top">
            <div class="navbar-title">
                <i class="fas fa-calendar-check"></i> Jadwal Distribusi
            </div>
        ...
        <div class="card-dashboard">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT * FROM jadwal ORDER BY tanggal DESC";
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            echo "<tr>
                                ...
                                <td>
                                    <button class="btn-action btn-edit" onclick='editJadwal({$row['id_jadwal']})'>Edit</button>
                                    <button class="btn-action btn-delete" onclick='deleteJadwal({$row['id_jadwal']})'>Hapus</button>
                                </td>
                            </tr>";
                            $no++;
                        }
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="border-radius: 15px;">
                <div class="modal-header" style="border-bottom: 1px solid #eee;">
                    <h5 class="modal-title" style="color: #0F4C81; font-weight: 700;">Tambah Jadwal</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form id="formJadwal" method="POST" action="proses_jadwal.php">
                ...
                <div class="modal-footer" style="border-top: 1px solid #eee;">
                    ...
                    <button type="button" class="btn btn-success" onclick="simpanJadwal()">Simpan</button>
                </div>
            </div>
        </div>
    </div>
        ...
        function deleteJadwal(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'proses_jadwal.php?action=hapus&id=' + id;
                }
            });
        }
    </script>
